...
import com.example.customquerymethods.model.Course;
import com.example.customquerymethods.repository.CourseRepository;
...
class CustomQueryMethodsApplicationTests {
    ...
    @Test
    void givenCreateCourseWhenLoadtheCourseThenExpectSomeCourse() {
